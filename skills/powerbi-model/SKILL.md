---
name: powerbi-model
description: Inspect and modify the connected Power BI Desktop semantic model using powerbi-agent — list tables, measures, relationships, and add new measures. Invoke when the user asks about the data model, wants a measure list, needs to add a measure, or is exploring table structure and relationships. Use when the user mentions: Activate when the user wants to inspect tables / measures / relationships, asks "what's in the model", wants to add a measure, or requests an overview of the data model..
license: MIT
---
