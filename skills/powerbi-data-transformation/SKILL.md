---
name: powerbi-data-transformation
description: ETL/ELT transformation patterns. Use when the user mentions: union, append, stack tables, combine datasets, convert data types, cast, type mismatch, key generation, surrogate key, hash key, join key, light join, merge, schema alignment, homogenise, data harmonisation, Power Query union, Spark union, M append, combine queries.
license: MIT
---
