---
name: powerbi-fabric-pipelines
description: Fabric Data Factory pipelines and orchestration. Use when the user mentions: data pipeline, ingestion, ETL, ELT, Fabric pipeline, Data Factory, copy activity, notebook, Spark, dataflow gen2, lakehouse, OneLake, data load, incremental load, watermark, CDC, change data capture, full load, delta load, pipeline orchestration.
license: MIT
---
