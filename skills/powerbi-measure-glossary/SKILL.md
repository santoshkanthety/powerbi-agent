---
name: powerbi-measure-glossary
description: Standard measure naming and documentation. Use when the user mentions: measure lineage, measure description, formula documentation, DAX glossary, business glossary, measure visibility, what does this measure do, measure dependency, measure catalogue, document measures, annotate measures, formula visibility, where is this measure used, measure impact, self-documenting model.
license: MIT
---
