---
name: powerbi-medallion-architecture
description: Bronze/Silver/Gold lakehouse design. Use when the user mentions: medallion, bronze, silver, gold, lakehouse, data lake, data architecture, layer design, raw layer, curated layer, semantic layer, OneLake.
license: MIT
---
