...
description: Power BI report theming via pbir.tools - color palettes, typography, text classes, theme templates, visual formatting, icons, background images, and conditional formatting rules. Use when the user mentions: theme, theming, color palette, brand colors, fonts, typography, text class, formatting, conditional formatting, theme template, theme apply, icon, background image, visual style, report style, color swap, push visual.
license: MIT
---
