---
name: powerbi-modifying-theme-json
...
Always use `pbir theme diff` to preview changes before applying, and open the report in Desktop once to confirm it loads before committing the file.
